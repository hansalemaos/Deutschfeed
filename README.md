...
| -------------------------------------------------------------- |- |
One of the best things to improve your German is reading every day a<br>little bit. This app refreshes the news feed from more than 50 German<br>newspapers every 15 minutes. You can improve your German by reading<br>the titles and the resumes. If you are interested in reading the whole<br>article, just click on the "Text" link.|<img src="66_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 2 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
When you start the app, it will download all new articles from the newspapers.|<img src="132_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 3 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
When the app is done refreshing, you can see all newsfeeds on one page.|<img src="198_800x800.png" width="400"/> |
